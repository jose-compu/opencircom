...
<head>
  ...
  <meta name="description" content="OpenCircom v0.8.1 documentation — installation, CLI, Hardhat/Foundry integration, security, and full circuit template reference." />
  ...
  <div class="docs-layout">
    ...
    <main class="docs-content">
      <header class="docs-header">
        ...
        <p class="docs-lead">v0.8.1 — ${templateCount} circuit templates, CLI tooling, integration guides, and auto-generated template reference from <code>circuits/**/*.circom</code>.</p>
      </header>
      ...
      <section class="docs-section" id="install">
        ...
        <p>Package version: <code>^0.8.1</code>. Circuits live under <code>node_modules/opencircom/circuits/</code>.</p>
      </section>
...
npx opencircom path</code></pre>
      ...
      <section class="docs-section" id="cli-ref">
        <h2>CLI reference</h2>
        <p>The <code>opencircom</code> CLI ships with the npm package (v0.7.0+; current <code>^0.8.1</code>):</p>
...
npm test</code></pre>
      ...
      <section class="docs-section" id="security">
        ...
        <ul class="docs-list">
          ...
          <li><strong>Audit (0.5.0) / Safe wrappers (0.8.0) / range checks (0.8.1):</strong> Binary constraints and range checks hardened in Switcher, ForceEqualIfEnabled, IncrementalMerkleInclusion, DivRem, and PadPKCS7; Safe* templates added for gates, mux, and Bits2Num; VoteCommit choice and MACI nonce bounded against Fr wraparound.</li>
 ...
 */</code></pre>
  ...
  <footer class="site-footer">
    <div class="container footer-inner">
      ...
      <p class="footer-copy">OpenCircom v0.8.1 · Generated by <code>npm run docs</code></p>
    </div>
  </footer>
